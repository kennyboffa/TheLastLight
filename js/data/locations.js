...
const LOOT_TABLES = {
  ...
  mixed_rare:      [['electronics',1,1],['chemicals',1,1],['bandage',1,2],['pistol_ammo',3,7]],
  ...
  mixed_light:     [['cloth',1,2],['rope',1,1],['batteries',1,1],['matches',1,2]],
  mixed_medium:    [['electronics',1,1],['batteries',1,2],['tools',0,1],['rope',1,2]],
  home_light:      [['cloth',1,3],['book',0,1],['matches',1,1],['toy',0,1],['canned_beans',0,1]],
  home_medium:     [['cloth',1,4],['wood',1,2],['book',0,1],['toy',0,1],['bandage',0,1],['canned_soup',0,1]],
...
const BUILDING_LOOT = {
  ...
  cabin_cabin:    [['wood',1,2],['cloth',1,2],['canned_beans',0,1],['book',0,1],['knife',0,1],['rifle_ammo',0,3]],
  factory_heavy:  [['metal',1,4],['electronics',1,2],['tools',0,1],['fuel',0,1],['rope',1,1]],
  factory_factory:[['metal',1,3],['electronics',0,1],['rope',0,1]],
  office_rare:    [['electronics',1,2],['chemicals',1,1],['pistol_ammo',0,6],['pistol',0,1]],
  office_medium:  [['batteries',1,2],['electronics',0,1],['book',0,1],['cloth',0,1]],
  mall_mall:      [['cloth',1,4],['rope',0,1],['bandage',0,1],['canned_beans',0,2],['bat',0,1],['energy_bar',0,1]],
  ...
  house_home:        [['cloth',1,3],['canned_beans',0,2],['book',0,1],['toy',0,1],['matches',0,1],['bandage',0,1]],
