...
const ENEMY_TEMPLATES = {
  scout_drone: {
    ...
    hp:9, maxHp:9, armor:1, accuracy:60,
  ...
  patrol_robot: {
    ...
    hp:20, maxHp:20, armor:4, accuracy:68,
  ...
  hunter_drone: {
    ...
    hp:14, maxHp:14, armor:2, accuracy:72,
  ...
  raider: {
    ...
    hp:15, maxHp:15, armor:1, accuracy:65,
    damage:[3,6], reward:{},
  ...
  raider_armed: {
    ...
    hp:18, maxHp:18, armor:2, accuracy:70,
    damage:[4,7], isRanged:true, reward:{},
  ...
  survivor_bandit: {
    ...
    hp:13, maxHp:13, armor:1, accuracy:60,
    damage:[3,5], reward:{},
  ...
  singularity_cultist: {
    ...
    hp:12, maxHp:12, armor:0, accuracy:58,
  ...
  wolf: {
    ...
    hp:11, maxHp:11, armor:0, accuracy:75,
    damage:[4,6], reward:{},
  ...
  wild_dog: {
    ...
    hp:7, maxHp:7, armor:0, accuracy:70,
    damage:[2,4], reward:{},
  ...
  boss_hunter: {
    ...
    hp:38, maxHp:38, armor:5, accuracy:80,
    damage:[6,11], reward:{ suspicion:-12 }, isBoss:true,
  ...
  boss_raider_chief: {
    ...
    hp:30, maxHp:30, armor:4, accuracy:75,
    damage:[6,10], isRanged:true, reward:{}, isBoss:true,
  ...
  boss_patrol_heavy: {
    ...
    hp:50, maxHp:50, armor:7, accuracy:72,
    damage:[8,13], reward:{ suspicion:-15 }, isBoss:true,
