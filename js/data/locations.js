...
const LOOT_TABLES = {
  ...
  mixed_medium:    [['electronics',1,1],['batteries',1,2],['tools',0,1],['rope',1,2],['note_trade_list',0,1]],
  ...
  church_main:     [['cloth',1,3],['book',1,1],['canned_beans',0,2],['bandage',1,2],['matches',1,1],['note_prayer',0,1],['note_survivor_tip',0,1]],
